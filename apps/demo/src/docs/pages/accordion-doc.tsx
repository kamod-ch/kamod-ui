...
<Accordion type="single" collapsible defaultValue="item-1" class="max-w-lg">
    ...
    preview: () => (
      <Accordion type="single" collapsible class="w-full max-w-lg">
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent class={contentClass()}>
            You can update your email address in your account settings. You&apos;ll receive a verification email at your
  ...
  borders: {
    preview: () => (
      <Accordion type="single" collapsible class="max-w-lg rounded-lg border" defaultValue="billing">
...
const apiSections = [
  ...
  },
  {
    ...
    description: "Height animation; optional forceMount, duration, timingFunction, largeContentThreshold.",
    rows: [
...
export const accordionDocPage: DocPageModule = {
  ...
  sections: [
    { id: "installation", title: "Installation", text: "Import Accordion, AccordionItem, AccordionTrigger, and AccordionContent." },
    {
      id: "usage",
      title: "Usage",
    ...
    { id: "multiple", title: "Multiple", text: "Several panels can stay open; defaultValue is a string array." },
    { id: "disabled", title: "Disabled", text: "Set disabled on AccordionItem to block interaction." },
