...
const apiSections = [
  {
    title: "AspectRatio",
    description: "Wrapper with CSS aspect-ratio; clip overflow. Child media should fill with h-full w-full object-cover.",
    rows: [
...
export const aspectRatioDocPage: DocPageModule = {
  ...
  sections: [
    ...
    { id: "demo", title: "Demo", text: "Default widescreen frame with muted background and rounded corners." },
    {
      id: "square",
      title: "Square",
